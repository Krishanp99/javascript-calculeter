...
function fnEQ(){
    ...
    if (op==1){
        document.getElementById("answer").innerHTML =parseInt(firstsave) +parseInt(secondsave);
    }else if(op == 2){
        document.getElementById("answer").innerHTML =parseInt(firstsave) -parseInt(secondsave);
    }else if(op == 3){
        document.getElementById("answer").innerHTML =parseInt(firstsave) *parseInt(secondsave);
...
function feraser(){
    let previous = document.getElementById("answer").innerHTML;
    let erased = previous.slice(0,-1);
    document.getElementById("answer").innerHTML =erased ;
}
